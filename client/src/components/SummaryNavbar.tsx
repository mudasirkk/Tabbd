  ...
  return (
    <header className="border-b border-border/50 sticky top-0 bg-background/90 backdrop-blur-sm z-10">
      <div className="container mx-auto max-w-screen-xl px-4 py-3 flex justify-between items-center gap-4">
        ...
        {/* Center: Stats Pill — full on lg, compact on sm-md */}
        ...
        {/* Compact stats for sm-md screens */}
        <div className="hidden sm:flex lg:hidden items-center gap-2 rounded-full bg-card/60 border border-border/50 px-3 py-1.5">
